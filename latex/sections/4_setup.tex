...
\paragraph{Elastic energy error} Let $U_H(t)$ be the reference energy generated by the human grasp and $U_R(t)$ be the actual energy stored in the robotic grasp. The absolute energy error is:
\begin{equation}
